...
$(document).ready(function(){(function(){})()});initAZAjax=function(n){var t=$.extend({},{azAjaxUrl:"",azAjaxDataType:"json",azAjaxType:"POST",azAjaxContentType:"application/json; charset=utf-8",azAjaxTimeout:15e3,azAjaxObjToSend:{},azAjaxExceptionAction:"silent",azAjaxExceptionErrorText:""},n||{}),i,r;return t.azAjaxUrl!=""?(i={url:t.azAjaxUrl,dataType:t.azAjaxDataType,type:t.azAjaxType,contentType:t.azAjaxContentType,timeout:t.azAjaxTimeout},t.azAjaxTransferType=t.azAjaxObjToSend.hasOwnProperty("TransferType")===!0?t.azAjaxObjToSend.TransferType:"",isEmpty(t.azAjaxObjToSend)===!1&&(i.data=JSON.stringify(t.azAjaxObjToSend),consoleLog(JSON.stringify(t.azAjaxObjToSend))),$.ajaxSetup({cache:!1}),r=$.ajax(i).promise(),r.fail(function(n){var i=n.statusText=="timeout"?"Timeout":t.azAjaxExceptionErrorText;throwException(t.azAjaxExceptionAction,"",ThisPage,t.azAjaxTransferType+":Status:"+n.statusText,i)}),r):$.Deferred().resolve("")};(typeof AppName=="undefined"||AppName===null)&&(AppName="AZ Team");(typeof AppVersion=="undefined"||AppVersion===null)&&(AppVersion="2.0.0");(typeof ApiVersion=="undefined"||ApiVersion===null)&&(ApiVersion="_1");var SingleNonLanguageElements={},SingleDefaultElements={},SingleElements={},ObjPageLanguage={},ObjCustomerInfo={},ThisCustomerName="",ThisUserNo="",ThisFirstName="",ThisLastName="",ThisEmail="",ThisProfileImage="",ThisLanguage="nb-NO",ThisUserType="",ObjJsonValidation={},ThisLocation="",ThisFormId="",ThisPage="",LanguagePage="",ValidationPage="",ModalDialogScrollTop=0,ObjInitializePageOptions={},DebugMode=!0;(function(n){var t=n({});n.each({trigger:"publish",on:"subscribe",one:"subscribeonce",off:"unsubscribe"},function(n,i){jQuery[i]=function(){t[n].apply(t,arguments)}})})(jQuery);var _$AZSnackbarText={},_$AZSnackbarClose={},_$AZSnackbarWrapper={},_$Table={};_$PortfolioMenu={};_$PortfolioContent={};$.urlParam=function(n){var t=new RegExp("[?&]"+n+"=([^&#]*)").exec(window.location.href);return t==null?null:t[1]||0};_WindowWidth=0;initializeAjax=function(n,t){var i=$.extend({},{dataType:"json",type:"POST",contentType:"application/json; charset=utf-8",timeout:15e3,exceptionAction:"silent",exceptionErrorText:"",transferType:""},n||{}),r;return typeof t=="object"&&(i.transferType=t.hasOwnProperty("TransferType")===!0?t.TransferType:"",i.data=JSON.stringify(t),consoleLog(JSON.stringify(t))),$.ajaxSetup({cache:!1}),r=$.ajax(i).promise(),r.fail(function(n){var t=n.statusText=="timeout"?"Timeout":i.exceptionErrorText;throwException(i.exceptionAction,"",ThisPage,i.transferType+":Status:"+n.statusText,t)}),r};